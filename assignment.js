...
guestList.forEach((invites) => {
    console.log("I feel immense pleasure to invite " +
        invites +
...
console.log("Sorry, You are no longer invited to my tea party, " +
    guestList.shift() +
...
//Question no.19;
console.log("The number of people invited to my tea party are " +
    guestList.length +
    "." +
    "\n \t Since all the guests had already been removed in the earlier tasks.");
//Question no.20;
let favoriteWebtoons = [
    "Your Throne",
    "Iseop's Romance",
    "Serena",
    "Forever After",
...
console.log("The car parked in the lot is of Brand " +
    car.Brand +
    ". Its model is: " +
    car.Model +
    ", costs about " +
...
console.log("Testing with toggle case function: \n", toggleCase("zahra") == "Zahra");
...
//Question no.30;
const usernames = ["User1", "User2", "admin", "User3", "User5"];
...
newUsernames.forEach((newusers) => {
    if (currentUsernames.some((currentusers) => currentusers.toLowerCase() == newusers.toLowerCase())) {
...
//Question no.34;
let pizzaFlavours = ["Fajitta", "Cheese", "Spicy tikka", "Olive"];
...
//Question no.38;
function location(city, country = "Pakistan") {
...
//Question no.41;
let magicians = ['Alice', 'Hook', 'Witch', 'Jack'];
...
magic(magicians);
//Question no.43;
let magician = ['Alice', 'Hook', 'Witch', 'Jack'];
...
function Car(manufacturer, model, ...options) {
    let madecar = { manufacturer, model };
